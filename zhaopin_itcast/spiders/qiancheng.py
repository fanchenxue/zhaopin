...
#         'LOG_LEVEL ': 'DEBUG',
#         # 'REDIS_PARAMS': {'password': 'Lxcc198#!', 'db': 1}
#     }
#     city_data = {
#         u"北京": "010000",
#         u"上海": "020000",
...
#             job_name = response.xpath('//h1/text()').extract_first().replace('\t','').strip()
#             company_name = response.xpath('//p[@class="cname"]/a/text()') or response.xpath('//a[@class="com_name "]/p/text()')
